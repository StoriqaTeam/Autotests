...
public class BuyNowUnionPay {

    WebDriver driver;
    Screenshot screenshot;

    public BuyNowUnionPay(WebDriver driver) {
        this.driver = driver;
    ...
    public void buy_now_UnionPay() throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(3000);
            iFrame().click();
            iFrame().sendKeys("3056");
            iFrame().sendKeys("9309");
            iFrame().sendKeys("0259");
            iFrame().sendKeys("04");
...
//            iFrame().sendKeys("42421");
            ...
            System.out.println("BuyNowUnionPay Error" + e.getMessage());
            screenshot.takesScreenshot("BuyNowUnionPay" + Getdate.Date());
        }
    }
}
