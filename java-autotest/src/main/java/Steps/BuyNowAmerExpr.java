...
public class BuyNowAmerExpr {

    WebDriver driver;
    Screenshot screenshot;

    public BuyNowAmerExpr(WebDriver driver) {
        this.driver = driver;
    ...
    public void buy_now_AmerExpr() throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(3000);
            iFrame().click();
            iFrame().sendKeys("3782");
            Thread.sleep(3000);
            iFrame().sendKeys("822463");
            Thread.sleep(3000);
            iFrame().sendKeys("10005");
//            iFrame().sendKeys("4242");
            iFrame().sendKeys("1234");
            iFrame().sendKeys("4243");
            ...
            System.out.println("BuyNowAmericanExpress Error" + e.getMessage());
            screenshot.takesScreenshot("BuyNowAmericanExpress" + Getdate.Date());
        }
    }
}
