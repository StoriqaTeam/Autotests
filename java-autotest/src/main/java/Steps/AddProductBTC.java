...
public class AddProductBTC {

    WebDriver driver;
    Screenshot screenshot;

    public AddProductBTC(WebDriver driver) { this.driver = driver; screenshot = new Screenshot(driver); }
    ...
    public void product_btc(int number, int attempts) throws InterruptedException {
        ...
        try {
            ...
            if (attempts > 1)product_btc(number, --attempts);
