...
public class BuyNowDiscover {

    WebDriver driver;
    Screenshot screenshot;

    public BuyNowDiscover(WebDriver driver) {
        this.driver = driver;
    ...
    public void buy_now_Discover() throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(3000);
            iFrame().click();
            iFrame().sendKeys("6011");
            iFrame().sendKeys("0009");
            iFrame().sendKeys("9013");
            iFrame().sendKeys("9424");
            ...
            System.out.println("BoyNowDiscover Error" + e.getMessage());
            screenshot.takesScreenshot("BoyNowDiscover" + Getdate.Date());
        }
