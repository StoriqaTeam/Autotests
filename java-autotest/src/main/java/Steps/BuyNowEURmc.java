...
public class BuyNowEURmc {

    WebDriver driver;
    Screenshot screenshot;

    public BuyNowEURmc(WebDriver driver) {
        this.driver = driver;
    ...
    public void buy_nowEUR_MC() throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(3000);
            iFrame().click();
            iFrame().sendKeys("5555");
            iFrame().sendKeys("5555");
            iFrame().sendKeys("5555");
            iFrame().sendKeys("4444");
            ...
            System.out.println("BuyNowMC Error" + e.getMessage());
            screenshot.takesScreenshot("BuyNowMC" + Getdate.Date());
        }
    }
}
